...
async function loadPublicationDetail(publicationId) {
  ...
  try {
    ...
    if (publication.content) {
      ...
      const isHtmlContent = /<[a-z][\s\S]*>/i.test(publication.content);
      const formattedContent = isHtmlContent ? publication.content : formatMarkdownContent(publication.content);
